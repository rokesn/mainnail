...
export default defineConfig(async ({ mode }) => {
  // On Vercel, we need to use @sparticuz/chromium to get a working binary.
  // Locally, we use the default system/npm chromium.
        ...
        ? [
            prerender({
              ...
              rendererOptions: {
                ...
                renderAfterTime: 10000, // Safety fallback
                launchOptions: {
                  executablePath,
                  args: isVercel
                ...
                timeout: 120000, // Increase timeout for slower first-run Vercel builds
              },
